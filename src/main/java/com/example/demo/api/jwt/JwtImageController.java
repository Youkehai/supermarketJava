...
//
//@RestController
//@RequestMapping(BaseController.OPEN_URL+"/upload")
...
//	@PostMapping("/upload")
//	public WebResult getUserInfo(@RequestParam("file") MultipartFile file,HttpServletResponse response) throws UnsupportedEncodingException {
